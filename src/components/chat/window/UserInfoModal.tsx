...
import { X, User, Mail, Info, ZoomIn } from 'lucide-react';
...
const UserInfoModal = ({ isOpen, onClose, user }: UserInfoModalProps) => {
  ...
  return (
    <>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="relative">
                      <div className="relative group">
                        <div 
                          className={`size-28 rounded-full overflow-hidden ring-4 ring-[#2a2a2a] relative ${
                            profilePic ? 'cursor-pointer hover:ring-[#00d9ff] transition-all duration-300' : ''
                          }`}
      ...
      {isFullscreenImageOpen && profilePic && (
