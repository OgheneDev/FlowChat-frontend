...
import { X, Search, Users, Check, MessageSquare, Send, Image as ImageIcon } from "lucide-react";
...
const ForwardModal = ({
  ...
  const { getAllContacts} = useContactStore();
            ...
            <div className="flex-1 overflow-y-auto">
              {isLoading ? (
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-[#999] text-sm mt-3">Loading contacts...</p>
                </div>
              ) : (
                <>
                  {/* Contacts */}
